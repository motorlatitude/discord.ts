...
var GuildEvent = /** @class */ (function (_super) {
    ...
    GuildEvent.prototype.HandleCreate = function (Message) {
        ...
        return new Promise(function (resolve) {
            _this.EventName = 'GUILD_CREATE';
            _this.EventObject = new Guild_1.default(_this.Client, Message);
            _this.Client.Guilds.AddGuild(_this.EventObject);
            _this.Handle();
    ...
    GuildEvent.prototype.HandleUpdate = function (Message) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.EventName = 'GUILD_UPDATE';
            _this.EventObject = new Guild_1.default(_this.Client, Message);
            _this.Client.Guilds.ReplaceGuild(Message.id, _this.EventObject);
            _this.Handle();
            resolve(_this.EventObject);
        });
    };
    ...
    GuildEvent.prototype.HandleDelete = function (Message) {
        ...
        return new Promise(function (resolve) {
            ...
            _this.Client.Guilds.RemoveGuild(Message.id);
            _this.Handle();
