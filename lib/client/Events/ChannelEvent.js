...
var ChannelEvent = /** @class */ (function (_super) {
    ...
    ChannelEvent.prototype.HandleCreate = function () {
        ...
        if (this.Message.type === channeltypes_1.default.GUILD_TEXT && this.Message.guild_id) {
            this.Client.Guilds.Fetch(this.Message.guild_id).then(function (AffectedGuild) {
                var NewTextChannel = new TextChannel_1.default(_this.Client, _this.Message);
            ...
            this.Client.Guilds.Fetch(this.Message.guild_id).then(function (AffectedGuild) {
                var NewVoiceChannel = new VoiceChannel_1.default(_this.Client, _this.Message);
            ...
            this.Client.Guilds.Fetch(this.Message.guild_id).then(function (AffectedGuild) {
                var NewChannelCategory = new CategoryChannel_1.default(_this.Client, _this.Message);
    ...
    ChannelEvent.prototype.HandleUpdate = function () {
        ...
        var NewChannel;
        if (this.Message.type === channeltypes_1.default.GUILD_TEXT) {
            NewChannel = new TextChannel_1.default(this.Client, this.Message);
        }
        else if (this.Message.type === channeltypes_1.default.GUILD_VOICE) {
            NewChannel = new VoiceChannel_1.default(this.Client, this.Message);
        }
        else if (this.Message.type === channeltypes_1.default.DM || this.Message.type === channeltypes_1.default.GROUP_DM) {
            NewChannel = new DirectMessageChannel_1.default(this.Client, this.Message);
        }
        else if (this.Message.type === channeltypes_1.default.GUILD_CATEGORY) {
            NewChannel = new CategoryChannel_1.default(this.Client, this.Message);
        }
        if (NewChannel) {
