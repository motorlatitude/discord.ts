...
export default class MessageEvent extends ClientDispatcherEvent {
   ...
   */
  public HandleMessageCreate(msg: IDiscordMessage): Promise<{Content: Message, Channel: TextChannel | DirectMessageChannel, Author: User, AffectedGuild?: Guild, AffectedGuildMember?: GuildMember}> {
    return new Promise((resolve, reject) => {
      if (msg.guild_id) {
        let AffectedGuild: Guild;
        let AffectedChannel: TextChannel;
        this.Client.Guilds.Fetch(msg.guild_id).then((FoundGuild: Guild) => {
   ...
   */
  public HandleMessageUpdate(msg: IDiscordMessageUpdateGatewayEvent): Promise<{Content: Message, Channel: TextChannel | DirectMessageChannel, Author: User, AffectedGuild?: Guild, AffectedGuildMember?: GuildMember}> {
    return new Promise((resolve, reject) => {
      if (msg.guild_id) {
        let AffectedGuild: Guild;
        let AffectedChannel: TextChannel;
        ...
        this.Client.Channels.FetchDirectMessageChannel(msg.channel_id).then((FoundChannel: DirectMessageChannel) => {
          AffectedChannel = FoundChannel;
          return AffectedChannel.Messages.Fetch(msg.id);
        }).then((AffectedMessage: Message) => {
          // TODO seems hacky, figure something better out here
   ...
   */
  public HandleMessageDelete(msg: IDiscordMessageDeleteGatewayEvent): Promise<{Content: Message, Channel: TextChannel | DirectMessageChannel, Author: User, AffectedGuild?: Guild, AffectedGuildMember?: GuildMember} | {Messages: Message[], Channel: TextChannel | DirectMessageChannel, AffectedGuild?: Guild}> {
    return new Promise((resolve, reject) => {
      if (msg.guild_id) {
        let AffectedGuild: Guild;
        this.Client.Guilds.Fetch(msg.guild_id).then((FoundGuild: Guild) => {
