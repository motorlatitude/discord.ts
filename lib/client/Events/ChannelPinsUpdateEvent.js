...
var ChannelPinsUpdateEvent = /** @class */ (function (_super) {
    ...
    ChannelPinsUpdateEvent.prototype.Handle = function () {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.Message.guild_id) {
                _this.GuildBasedChannel(_this.Message.guild_id)
                    .then(function (res) {
                    resolve(res);
                })
                    .catch(function (err) {
                ...
                // DM
                _this.Client.Channels.FetchAllTypes(_this.Message.channel_id).then(function (AffectedChannel) {
                    if (AffectedChannel instanceof TextChannel_1.default || AffectedChannel instanceof DirectMessageChannel_1.default) {
                        ...
                        var ErrorResponse = new Error('This channel cannot have a pinned message');
     ...
     */
    ChannelPinsUpdateEvent.prototype.GuildBasedChannel = function (GuildId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var AffectedGuild;
            _this.Client.Guilds.Fetch(GuildId)
                .then(function (FoundGuild) {
                AffectedGuild = FoundGuild;
                return AffectedGuild.Channels.FetchAllTypes(_this.Message.channel_id);
            })
