...
var ChannelStore = /** @class */ (function (_super) {
     ...
     * @param ChannelId - channel id of the text channel
     */
    ChannelStore.prototype.FetchVoiceChannel = function (ChannelId) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var Channel = _this.Get(ChannelId);
            if (Channel instanceof VoiceChannel_1.default) {
                resolve(Channel);
            }
            else {
                reject(new Error('The returned channel for the id is not a VoiceChannel'));
            }
        });
    };
    /**
